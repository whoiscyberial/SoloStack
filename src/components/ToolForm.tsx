...
//   });
// categories: {
//   data: Array<ValidationSchema & { id: string }>;
//   isLoading: boolean;
// }
...
const ToolForm = () => {
  ...
  return (
    <form
      className="mb-4 w-screen border border-neutral-800/30 px-8 pb-8 pt-6 shadow-2xl shadow-neutral-900 dark:bg-neutral-900 md:w-[70vw] lg:w-[70vw] xl:w-[50vw]"
