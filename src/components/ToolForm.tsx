  ...
  return (
    ...
    >
      <form
        ...
        className="absolute left-[50%] top-[50%] z-20 mb-4 w-screen translate-x-[-50%] translate-y-[-50%] flex-col rounded-md border border-neutral-800/30 px-8 pb-8 pt-6 shadow-2xl shadow-neutral-900 dark:bg-neutral-900 md:w-[70vw] lg:w-[70vw] xl:w-[50vw]"
      ...
      >
        ...
        <div className="mb-4 w-full">
          <label className="mb-2 block font-semibold" htmlFor="subcategoryId">
            Subcategory
          </label>
          <select
            className={`w-full border px-3 py-2 text-sm leading-tight ${
